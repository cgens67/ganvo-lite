...
import com.ganvo.music.viewmodels.BackupRestoreViewModel
...
private fun InfoSection() {
    ElevatedCard(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.backup_visitor_data_note),
        ...
        is UploadStatus.Failure -> {
            Card(
                ...
                Row(
                    ...
                    Spacer(modifier = Modifier.width(16.dp))
                    Text(
                        text = stringResource(R.string.upload_backup_error),
                        style = MaterialTheme.typography.bodyMedium,
