...
class MusicWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.ganvo.music.ACTION_PLAY_PAUSE"
        const val ACTION_PREV = "com.ganvo.music.ACTION_PREV"
        const val ACTION_NEXT = "com.ganvo.music.ACTION_NEXT"
        const val ACTION_SHUFFLE = "com.ganvo.music.ACTION_SHUFFLE"
        const val ACTION_LIKE = "com.ganvo.music.ACTION_LIKE"
        const val ACTION_REPLAY = "com.ganvo.music.ACTION_REPLAY"
        const val ACTION_STATE_CHANGED = "com.ganvo.music.ACTION_STATE_CHANGED"
        const val ACTION_UPDATE_PROGRESS = "com.ganvo.music.ACTION_UPDATE_PROGRESS"
