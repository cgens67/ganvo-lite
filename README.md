# ganvo-lite
  ...
  [![Latest Version](https://img.shields.io/github/v/release/cgens67/ganvo-lite?style=flat-square&logo=github&color=0D1117&labelColor=161B22)](https://github.com/cgens67/ganvo-lite/releases)
  [![License](https://img.shields.io/github/license/cgens67/ganvo-lite?style=flat-square&logo=gnu&color=2B3137&labelColor=161B22)](https://github.com/cgens67/ganvo-lite/blob/main/LICENSE)
  ...
  [![Stars](https://img.shields.io/github/stars/cgens67/ganvo-lite?style=flat-square&logo=github&color=yellow&labelColor=161B22)](https://github.com/cgens67/ganvo-lite/stargazers)
  [![Forks](https://img.shields.io/github/forks/cgens67/ganvo-lite?style=flat-square&logo=github&color=blue&labelColor=161B22)](https://github.com/cgens67/ganvo-lite/network/members)
</div>
...
**ganvo-lite** is an open-source YouTube Music client designed for Android devices. It offers a superior user experience with a modern interface implementing Material Design 3, providing advanced features to browse, play, and manage music content without the limitations of the official app.
...
> **Note**: ganvo-lite is an independent project and is not affiliated with, sponsored, or endorsed by YouTube or Google.
...
[![Documentation](https://img.shields.io/badge/Documentation-GitBook-4285F4?style=for-the-badge&logo=gitbook&logoColor=white)](https://ganvo-lite.gitbook.io/)
...
1. Navigate to the [Releases](https://github.com/cgens67/ganvo-lite/releases) section on GitHub
...
1. Visit the [official ganvo-lite website](https://ganvo-lite.netlify.app/)
...
git clone https://github.com/cgens67/ganvo-lite.git
...
3. Navigate to and select the ganvo-lite directory
...
All participants in this project are expected to adhere to our code of conduct, which promotes an inclusive, respectful, and constructive environment. Please review the [full Code of Conduct](https://github.com/cgens67/ganvo-lite/blob/master/CODE_OF_CONDUCT.md) before contributing.

### Translation

Help translate ganvo-lite into your language or improve existing translations:
...
[![Crowdin](https://img.shields.io/badge/Crowdin-2E3440?style=for-the-badge&logo=crowdin&logoColor=white)](https://crowdin.com/project/ganvo-lite)
...
[![Telegram Chat](https://img.shields.io/badge/Telegram-Chat-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/ganvo-lite_chat)
[![Telegram Updates](https://img.shields.io/badge/Telegram-Updates-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/ganvo-lite_updates)

</div>

### Development Workflow

1. **Review Issues**: Check [open issues](https://github.com/cgens67/ganvo-lite/issues) or create a new one describing the bug or feature
...
> **Development Guidelines**: Review our [contribution guidelines](https://github.com/cgens67/ganvo-lite/blob/master/CONTRIBUTING.md) for detailed information on the development process, code standards, and workflow.

---

## Support the Project

If you find value in **ganvo-lite** and want to contribute to its ongoing development, please consider making a donation. Your financial support allows us to:
...
> **Note**: Donations are completely optional. ganvo-lite will always be free and open source, regardless of any financial support received.
...
This program is distributed in the hope that it will be useful, but **WITHOUT ANY WARRANTY**; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the [GNU General Public License](https://github.com/cgens67/ganvo-lite/blob/main/LICENSE) for more details.
