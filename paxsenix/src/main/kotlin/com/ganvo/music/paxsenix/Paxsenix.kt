package com.ganvo.music.paxsenix

import android.content.Context
import com.ganvo.music.betterlyrics.TTMLParser
import com.ganvo.music.paxsenix.models.AppleMusicSearchResponse
import com.ganvo.music.paxsenix.models.LyricsResponse
import com.ganvo.music.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Ganvo/$appVersion")
                }
