---
name: Bug Report
about: Report a bug found in Ganvo to help us improve the application
...
```
**How to capture logs:**
- Use `adb logcat | grep -i Ganvo` for filtered logs
...
- [ ] I have tested on the latest version of Ganvo
